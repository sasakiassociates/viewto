...
namespace ViewObjects.Converter.Unity
{
	...
	public class ContentBundleConverter : ComponentConverter<ContentBundleBase, ContentBundleMono>
	{
		protected override Base ConvertComponent(ContentBundleMono component) => throw new System.NotImplementedException();

		protected override void ConvertBase(ContentBundleBase @base, ref ContentBundleMono instance)
		{
