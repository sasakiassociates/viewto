...
export default class Converter {
  ...
  async MeshToBufferGeometry( obj, scale = true ) {
    try {
      ...
      if (buffer.computeVertexNormals) buffer.computeVertexNormals( )
      // if (buffer.computeFaceNormals) buffer.computeFaceNormals( )
      // if (buffer.normalizeNormals) buffer.normalizeNormals( )
      if (buffer.computeBoundingSphere) buffer.computeBoundingSphere( )
